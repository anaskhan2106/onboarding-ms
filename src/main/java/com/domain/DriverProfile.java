...
public class DriverProfile {
    ...
    public String getIsDocumentsVerified() {
        return isDocumentsVerified;
    }

    public void setIsDocumentsVerified(String isDocumentsVerified) {
        this.isDocumentsVerified = isDocumentsVerified;
    }

    public String getIsReadyForRide() {
        return isReadyForRide;
    }

    public void setIsReadyForRide(String isReadyForRide) {
